...
<?php
	...
	echo "<tr class=".$rowColor."><th>ID</th><th>Nome</th><th>Célula</th><th>X</th><th>Y</th><th>Estado</th></tr>";
	...
	if($stmt != false){
		while($row = sqlsrv_fetch_array($stmt)){
			...
			echo "<tr class=".$rowColor."><td>".$row['id']."</td><td>".$row[$columnOneName]."</td><td>".$row['point_cell']."</td><td>".$row['point_posx']."</td><td>".$row['point_posy']."</td><td>".$row['state']."</td></tr>";
		}
	}	
	echo "</table></div>";
