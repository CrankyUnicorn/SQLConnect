...
<?php
	...
	echo "<tr class=".$rowColor."><th>ID</th><th>Nome</th><th>Password</th><th>Email</th><th>Estado</th></tr>";
	...
	if($stmt != false){
		while($row = sqlsrv_fetch_array($stmt)){
			...
			echo "<tr class=".$rowColor."><td>".$row['id']."</td><td>".$row['nick_name']."</td><td>".$row['passwd']."</td><td>".$row['email']."</td><td>".$row['state']."</td></tr>";
		}
	}	
	echo "</table></div>";
